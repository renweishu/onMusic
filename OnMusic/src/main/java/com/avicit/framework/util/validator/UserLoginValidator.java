...
public class UserLoginValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "name", DproMessageConsts.VALID_REQUIRE_NAME, "用户名不能为空............");
		ValidationUtils.rejectIfEmpty(errors, "pwd", DproMessageConsts.VALID_REQUIRE_PWD,"密码不能为空............");
